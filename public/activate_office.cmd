...
title Activate Microsoft Office
cls
echo ============================================================================
echo #Activate Microsoft Office (by MSGuides.com)
echo ============================================================================
echo.
...
(
  ...
  echo.
  echo #Please feel free to contact msguides.com@gmail.com if you have any questions or concerns.
  echo.
  echo #Please consider supporting this project: donate.msguides.com
  echo #Your support is helping MSGuides keep my servers running everyday!
  echo.
  echo ============================================================================
  exit
) || (
